/**
  ...
  file:///C:/Puneet/education/TU_Darmstadt/Theses/Attempt5/Transpilation/SCXMLToC/input/test_invoke_ftp.scxml
*/
...
extern const uscxml_machine _uscxml_EA0D0E22__machine;

#ifndef USCXML_NO_ELEM_INFO

static const uscxml_elem_donedata _uscxml_EA0D0E22__elem_donedatas[1] = {
...
static const uscxml_elem_invoke _uscxml_EA0D0E22__elem_invokes[1] = {
    { 
        /* machine     */ NULL, 
        /* type        */ "contiki_ftp", 
        /* typeexpr    */ NULL, 
...
static int _uscxml_EA0D0E22__s0_invoke(const uscxml_ctx* ctx, const uscxml_state* s, const uscxml_elem_invoke* invocation, unsigned char uninvoke) {
    ctx->invoke(ctx, s, &_uscxml_EA0D0E22__elem_invokes[0], uninvoke);

    return USCXML_ERR_OK;
}
static int _uscxml_EA0D0E22__pass_on_entry_0(const uscxml_ctx* ctx, const uscxml_state* state, const void* event) {
...
static int _uscxml_EA0D0E22__pass_on_entry(const uscxml_ctx* ctx, const uscxml_state* state, const void* event) {
    _uscxml_EA0D0E22__pass_on_entry_0(ctx, state, event);
    return USCXML_ERR_OK;
}

static int _uscxml_EA0D0E22__fail_on_entry_0(const uscxml_ctx* ctx, const uscxml_state* state, const void* event) {
    int err = USCXML_ERR_OK;
    if likely(ctx->exec_content_log != NULL) {
...
static int _uscxml_EA0D0E22__fail_on_entry(const uscxml_ctx* ctx, const uscxml_state* state, const void* event) {
    _uscxml_EA0D0E22__fail_on_entry_0(ctx, state, event);
    return USCXML_ERR_OK;
}
...
static const uscxml_state _uscxml_EA0D0E22__states[5] = {
    {   /* state number 0 */
        /* name       */ NULL,
        /* parent     */ 0,
        /* onentry    */ NULL,
    ...
    {   /* state number 1 */
        ...
        /* onentry    */ NULL,
        /* onexit     */ NULL,
        /* invoke     */ _uscxml_EA0D0E22__s0_invoke,
        /* children   */ { 0x04 /* 00100 */ },
        /* completion */ { 0x04 /* 00100 */ }, 	
    ...
    {   /* state number 3 */
        /* name       */ "pass",
        /* parent     */ 0,
        /* onentry    */ _uscxml_EA0D0E22__pass_on_entry,
        /* onexit     */ NULL,
        /* invoke     */ NULL,
        /* children   */ { 0x00 /* 00000 */ },
        /* completion */ { 0x00 /* 00000 */ }, 	
    ...
    {   /* state number 4 */
        /* name       */ "fail",
        /* parent     */ 0,
        /* onentry    */ _uscxml_EA0D0E22__fail_on_entry,
        /* onexit     */ NULL,
        /* invoke     */ NULL,
        /* children   */ { 0x00 /* 00000 */ },
        /* completion */ { 0x00 /* 00000 */ }, 	
...
static const uscxml_transition _uscxml_EA0D0E22__transitions[1] = {
    {   /* transition number 0 with priority 0
           target: pass
         */
        /* source     */ 2,
        /* target     */ { 0x08 /* 00010 */ },
        /* event      */ "event_from_ftp",
        /* condition  */ NULL,
        /* is_enabled */ NULL,
        /* ontrans    */ NULL,
        /* type       */ 0,
...
#  define USCXML_MACHINE _uscxml_EA0D0E22__machine
#endif
#define USCXML_MACHINE_0 _uscxml_EA0D0E22__machine
#define USCXML_MACHINE_TEST_INVOKE_FTP_SCXML _uscxml_EA0D0E22__machine

const uscxml_machine _uscxml_EA0D0E22__machine = {
        /* flags          */ 0,
        /* nr_states      */ 5,
        /* nr_transitions */ 1,
        /* name           */ "test_invoke_ftp.scxml",
        /* datamodel      */ "promela",
        /* uuid           */ "EA0D0E22D008F9161C90051DD865BE4A",
        /* states         */ &_uscxml_EA0D0E22__states[0], 
        /* transitions    */ &_uscxml_EA0D0E22__transitions[0], 
        /* parent         */ NULL,
        /* donedata       */ &_uscxml_EA0D0E22__elem_donedatas[0], 
        /* script         */ NULL
};
