/**
  ...
  file:///C:/Puneet/education/TU_Darmstadt/Theses/Attempt5/Transpilation/SCXMLToC/input/test_invoke_calc.scxml
*/
...
extern const uscxml_machine _uscxml_4A53CE53__machine;

#ifndef USCXML_NO_ELEM_INFO

static const uscxml_elem_assign _uscxml_4A53CE53__elem_assigns[1] = {
    /* location, expr, content */
    { "var1", "_event.data.calc_result", NULL },
};

static const uscxml_elem_data _uscxml_4A53CE53__elem_datas[2] = {
    /* id, src, expr, content */
    { "var1", NULL, "-88756", NULL },
    { NULL, NULL, NULL, NULL }
};

static const uscxml_elem_donedata _uscxml_4A53CE53__elem_donedatas[1] = {
...
static const uscxml_elem_invoke _uscxml_4A53CE53__elem_invokes[1] = {
    { 
        /* machine     */ NULL, 
        /* type        */ "contiki_calc", 
        /* typeexpr    */ NULL, 
...
static int _uscxml_4A53CE53__s0_invoke(const uscxml_ctx* ctx, const uscxml_state* s, const uscxml_elem_invoke* invocation, unsigned char uninvoke) {
    ctx->invoke(ctx, s, &_uscxml_4A53CE53__elem_invokes[0], uninvoke);

    return USCXML_ERR_OK;
}
static int _uscxml_4A53CE53__pass_on_entry_0(const uscxml_ctx* ctx, const uscxml_state* state, const void* event) {
...
static int _uscxml_4A53CE53__pass_on_entry(const uscxml_ctx* ctx, const uscxml_state* state, const void* event) {
    _uscxml_4A53CE53__pass_on_entry_0(ctx, state, event);
    return USCXML_ERR_OK;
}

static int _uscxml_4A53CE53__fail_on_entry_0(const uscxml_ctx* ctx, const uscxml_state* state, const void* event) {
    int err = USCXML_ERR_OK;
    if likely(ctx->exec_content_log != NULL) {
...
static int _uscxml_4A53CE53__fail_on_entry(const uscxml_ctx* ctx, const uscxml_state* state, const void* event) {
    _uscxml_4A53CE53__fail_on_entry_0(ctx, state, event);
    return USCXML_ERR_OK;
}

static int _uscxml_4A53CE53__s01_transition0_on_trans(const uscxml_ctx* ctx, const uscxml_state* state, const void* event) {
    int err = USCXML_ERR_OK;
    if likely(ctx->exec_content_assign != NULL) {
        if ((ctx->exec_content_assign(ctx, &_uscxml_4A53CE53__elem_assigns[0])) != USCXML_ERR_OK) return err;
    } else {
        return USCXML_ERR_MISSING_CALLBACK;
    }
    return USCXML_ERR_OK;
...
static const uscxml_state _uscxml_4A53CE53__states[6] = {
    {   /* state number 0 */
        /* name       */ NULL,
        /* parent     */ 0,
        /* onentry    */ NULL,
        ...
        /* data       */ &_uscxml_4A53CE53__elem_datas[0],
    ...
    {   /* state number 1 */
        ...
        /* onentry    */ NULL,
        /* onexit     */ NULL,
        /* invoke     */ _uscxml_4A53CE53__s0_invoke,
    ...
    {   /* state number 4 */
        /* name       */ "pass",
        /* parent     */ 0,
        /* onentry    */ _uscxml_4A53CE53__pass_on_entry,
        /* onexit     */ NULL,
        /* invoke     */ NULL,
        /* children   */ { 0x00 /* 000000 */ },
        /* completion */ { 0x00 /* 000000 */ }, 	
    ...
    {   /* state number 5 */
        /* name       */ "fail",
        /* parent     */ 0,
        /* onentry    */ _uscxml_4A53CE53__fail_on_entry,
        /* onexit     */ NULL,
        /* invoke     */ NULL,
        /* children   */ { 0x00 /* 000000 */ },
        /* completion */ { 0x00 /* 000000 */ }, 	
...
static const uscxml_transition _uscxml_4A53CE53__transitions[1] = {
    {   /* transition number 0 with priority 0
           target: s02
         */
        /* source     */ 2,
        /* target     */ { 0x08 /* 000100 */ },
        /* event      */ "event_from_calc",
        /* condition  */ NULL,
        /* is_enabled */ NULL,
        /* ontrans    */ _uscxml_4A53CE53__s01_transition0_on_trans,
        /* type       */ 0,
        /* conflicts  */ { 0x01 /* 1 */ }, 
...
#  define USCXML_MACHINE _uscxml_4A53CE53__machine
#endif
#define USCXML_MACHINE_0 _uscxml_4A53CE53__machine
#define USCXML_MACHINE_TEST_INVOKE_CALC_SCXML _uscxml_4A53CE53__machine

const uscxml_machine _uscxml_4A53CE53__machine = {
        /* flags          */ 0,
        /* nr_states      */ 6,
        /* nr_transitions */ 1,
        /* name           */ "test_invoke_calc.scxml",
        /* datamodel      */ "promela",
        /* uuid           */ "4A53CE5341CCC5CB1DB597541717BACE",
        /* states         */ &_uscxml_4A53CE53__states[0], 
        /* transitions    */ &_uscxml_4A53CE53__transitions[0], 
        /* parent         */ NULL,
        /* donedata       */ &_uscxml_4A53CE53__elem_donedatas[0], 
        /* script         */ NULL
};
